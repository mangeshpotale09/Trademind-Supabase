...
import { calculatePnL, getRegisteredUsers, exportTradesToCSV } from '../services/storageService';
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center mb-2 px-1">
        <h3 className="text-lg font-black text-white">Journal Log</h3>
        <button 
          onClick={() => exportTradesToCSV(trades)}
          className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-xl text-blue-400 font-black text-[10px] uppercase tracking-widest hover:bg-blue-500/20 transition-all shadow-lg"
        >
